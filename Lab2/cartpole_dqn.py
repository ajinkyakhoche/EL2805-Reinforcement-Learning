...
###############################################################################
        ...
        if np.random.random() < self.epsilon:
            ...
            Q_tmp = self.model.predict(state)
            action = np.argmax(Q_tmp)
...
###############################################################################
    ...
    def train_model(self):
        ...
        mini_batch = random.sample(self.memory, batch_size) #Uniformly sample the memory buffer  #line 7
...
if __name__ == "__main__":
    ...
    for e in range(EPISODES):
        ...
        while not done:
            ...
            action = agent.get_action(state)    #e-greedy policy!!!! line3
            next_state, reward, done, info = env.step(action)  #line4
            ...
            if done:
                ...
                if e % agent.target_update_frequency == 0:   #line 14
